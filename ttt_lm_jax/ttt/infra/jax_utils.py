...
def _with_sharding_constraint(x, partition_specs):
    # No-op for non-distributed settings.
    return x
...
def log_ttt_stats(layer, ttt_stats_layer, x_axis, step):
    ssl_tgt_last_in_mini_batch_from_mean_mse = ttt_stats_layer[0]
